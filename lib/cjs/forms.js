...
var _FormField_value, _FormField_errors, _FormField_validators, _FormField_isTouched, _FormArray_groups, _FormArray_FormClass, _Form_fields, _Form_dynamicFormValidators, _Form_errors;
...
class FormField {
    constructor({ name = '', validators = [], errors = [], value = '', placeholder = '', type = 'text', id = null, isTouched = false, } = {}) {
        ...
        this.placeholder = '';
        this.type = '';
        _FormField_isTouched.set(this, void 0);
        ...
        this.type = type;
        this.id = id ? id : name ? name : 'field' + '-' + (0, uuid_1.v4)();
        __classPrivateFieldSet(this, _FormField_isTouched, isTouched, "f");
    }
    static create(data = {}) {
    ...
    get isTouched() {
        return __classPrivateFieldGet(this, _FormField_isTouched, "f");
    }
    set isTouched(touched) {
        __classPrivateFieldSet(this, _FormField_isTouched, touched, "f");
    }
...
_FormField_value = new WeakMap(), _FormField_errors = new WeakMap(), _FormField_validators = new WeakMap(), _FormField_isTouched = new WeakMap();
class FormArray {
    ...
    add(group = __classPrivateFieldGet(this, _FormArray_FormClass, "f") ? __classPrivateFieldGet(this, _FormArray_FormClass, "f").replicate() : null) {
...
class Form {
    constructor(kwargs = {}) {
        ...
        for (const fieldName in __classPrivateFieldGet(this, _Form_fields, "f")) {
            ...
            const field = __classPrivateFieldGet(this, _Form_fields, "f")[fieldNameKey];
            /**
    ...
    replicate() {
        ...
        const formFieldOpts = Object.fromEntries(newForm.fields
            ...
            .filter(Boolean));
        __classPrivateFieldSet(newForm, _Form_fields, formFieldOpts, "f");
    ...
    get fields() {
        const result = Object.values(__classPrivateFieldGet(this, _Form_fields, "f"));
        return result;
    }
    copy(opts = {}) {
