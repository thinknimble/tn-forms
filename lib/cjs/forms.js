    ...
    constructor({ name = '', validators = [], errors = [], value, placeholder = '', type = 'text', id = null, isTouched = false, label = '', } = {}) {
        ...
        this.value = (Array.isArray(value)
            ...
            : value !== null && typeof value == 'object'
                ? Object.assign({}, value) : value === undefined
                ? ''
                : value);
        this.name = (name ? name : react_native_uuid_1.default.v4());
        this.errors = errors;
        this.validators = validators;
        this.placeholder = placeholder;
        this.type = type;
        this.id = id ? id : name ? name : 'field' + '-' + react_native_uuid_1.default.v4();
...
class Form {
    ...
    addFormLevelValidator(fieldName, validator) {
        ...
        if ((0, utils_1.isFormArray)(currentField)) {
            throw new Error(JSON.stringify({
    ...
    get errors() {
        ...
        return Object.assign(Object.assign(Object.assign({}, this._errors), formFieldErrors), formArrayErrors);
    }
    set errors(errs) {
        this._errors = errs;
    }
    get value() {
        ...
        return Object.assign(Object.assign({}, formFieldValues), formArrayValues);
    }
    get isValid() {
        try {
            let { formArrays, formFields } = fields(this.fields);
